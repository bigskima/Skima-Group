...
export function TransactionsScreen(props: CustomerScreenProps) {
  ...
  return (
    <QueryState loading={deposits.isLoading || withdrawals.isLoading || currencies.isLoading} error={deposits.error ?? withdrawals.error ?? currencies.error} skeleton={<ActivityListSkeleton />}>
