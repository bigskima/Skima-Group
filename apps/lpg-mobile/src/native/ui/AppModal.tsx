    ...
    <View style={[styles.backdrop, { backgroundColor: palette.overlay }]}>
      ...
      <View accessibilityViewIsModal style={[styles.card, shadows.floating, { backgroundColor: palette.elevated, borderColor: palette.border }]}>
        <View style={styles.header}>
          ...
          <Pressable accessibilityLabel="Close dialog" hitSlop={8} onPress={onClose} style={[styles.close, { backgroundColor: palette.surfaceSubtle }]}>
            <X color={palette.mutedStrong} size={18} />
          </Pressable>
        </View>
        <ScrollView
...
const styles = StyleSheet.create({
  ...
  card: { width: "100%", maxWidth: 520, maxHeight: "84%", borderWidth: 1, borderRadius: radii.xl, padding: spacing.lg },
  header: { flexDirection: "row", alignItems: "flex-start", gap: spacing.md, marginBottom: spacing.lg },
  copy: { flex: 1, minWidth: 0, gap: 5 },
  accent: { width: 34, height: 4, borderRadius: radii.pill, marginBottom: 3 },
  title: { ...typography.heading },
  description: { ...typography.caption, lineHeight: 18 },
  close: { width: 40, height: 40, flexShrink: 0, borderRadius: 13, alignItems: "center", justifyContent: "center" },
  content: { gap: spacing.lg, paddingBottom: 2 },
});