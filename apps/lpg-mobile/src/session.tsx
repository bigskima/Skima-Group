...
export function LpgSessionProvider(props: { readonly children: ReactNode }) {
...
function ConfigurationError(props: { readonly message: string }) {
  return (
    <main className="lpg-app-shell">
      <section className="lpg-state-card" role="alert">
...
export function useLpgSession(): SessionState {
  const context = useContext(SessionStateContext);

  if (!context) {
    throw new Error("useLpgSession must be used within LpgSessionProvider.");
  }
