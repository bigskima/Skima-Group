...
const contentSurfacePresets: readonly ContentSurfacePreset[] = [
  ...
  },
  {
    ...
    description: "Third onboarding image: QR/cylinder identity and live progress tracking across the selected fulfillment route.",
    recommendedSize: "WebP/PNG, 1600×1200px or 4:3",
    icon: QrCode,
    ...
    body: "Your cylinder is checked at every hand-off, and you can follow its journey across the selected fulfillment route.",
    moduleKey: "lpg",
    audienceKeys: "public, customer",
    ctaLabel: "",
    ctaType: "",
  ...
  },
  {
    ...
    description: "Fourth onboarding image: SKIMA coordinates the available refill route for the customer.",
    recommendedSize: "WebP/PNG, 1600×1200px or 4:3",
    icon: Flame,
    ...
    body: "SKIMA coordinates the available fulfillment route for your area and keeps the refill protected.",
    moduleKey: "lpg",
    audienceKeys: "public, customer",
    ctaLabel: "",
    ctaType: "",
