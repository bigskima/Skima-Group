...
export const financeConsoleConfig: AdminResourceConsoleConfig = {
  ...
  title: "Finance",
  description:
    "Manage wallets, deposits, withdrawals, escrow, commissions, settlements, and reconciliation.",
  groups: [
    {
      key: "wallets",
      ...
      actions: [
        ...
        action(
          ...
          [
            ...
            requiredNumber("amount", "Amount"),
            optionalNumber("feeAmount", "Fee Amount"),
            optionalJson(),
          ],
          "platform.financial.manage",
        ),
      ...
      actions: [
        ...
        action(
          ...
          [
            ...
            optionalText("commissionPolicyKey", "Commission Policy Key"),
            optionalNumber("baseAmount", "Base Amount"),
            optionalJson(),
          ],
          "platform.financial.manage",
        ),
        action(
          ...
          [
            ...
            optionalNumber("platformFeeAmount", "Platform Fee Amount"),
            optionalJson(),
          ],
          "platform.financial.manage",
        ),
        action(
          "execute-service-settlement",
          "Settle Service Request",
          "/runtime/settlements/execute",
          [
            requiredText("serviceRequestId", "Service Request ID"),
            requiredText("escrowHoldId", "Escrow Hold ID"),
            requiredJson("distribution", "Distribution", []),
            optionalJson(),
          ],
          "platform.financial.manage",
          "danger",
