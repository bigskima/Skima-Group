  ...
  groups: [
    {
      ...
      actions: [
        action(
          ...
          [
            requiredText("policyKey", "Stable Policy Key", "Example: pricing.lpg.delivery"),
            requiredText("displayName", "Policy Name"),
            {
              key: "policyFamily",
              label: "Policy Family",
              type: "select",
              required: true,
              options: financialPolicyFamilyOptions,
              defaultValue: "pricing",
            },
            requiredText("currencyCode", "Currency", "Use an enabled currency such as NGN."),
            optionalText("moduleKey", "Business Line", "Example: lpg. Leave empty for universal policy."),
            optionalText("serviceKey", "Service Scope", "Example: lpg.refill."),
            optionalText("organizationId", "Organization ID"),
            {
              key: "geographyType",
            ...
            optionalText("geographyKey", "Geography / Service Area Key"),
            requiredJson(
              "configuration",
              "Policy Rules",
              {},
              "Authoritative rules used by the backend engine. Amounts belong here, never in the mobile app.",
            ),
            {
              key: "effectiveFrom",
            ...
            { key: "effectiveUntil", label: "Effective Until", type: "datetime" },
            requiredText("changeReason", "Business Reason"),
            optionalNumber("priority", "Priority", "Lower values win only after scope specificity."),
            optionalJson(),
          ],
