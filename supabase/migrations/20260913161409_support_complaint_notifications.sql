...
begin
  ...
  exception when others then
    -- Support delivery must never fail because notification delivery is unavailable.
    null;
  end;
...
begin
  ...
  exception when others then
    -- Complaint review must never fail because notification delivery is unavailable.
    null;
  end;
