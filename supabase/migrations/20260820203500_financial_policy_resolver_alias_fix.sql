...
-- `financial_policy_versions` has a numeric column named `version`. The old
-- resolver also aliased the table as `version`, so PostgreSQL bound the first
-- argument of financial_policy_scope_matches() to the integer column instead
-- of the composite row. Use an unambiguous row alias.
