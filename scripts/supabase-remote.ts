...
Commands:
  ...
  functions-deploy  Deploy health, api-gateway, finance-runtime, verification-runtime, verification-provider-webhook, runtime-worker, inventory-provider-webhook, payment-webhook, and webhook-sandbox-receiver
